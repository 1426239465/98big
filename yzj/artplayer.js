...
function(t, e) {
	...
	var u = o((function(t, e) {
		t.exports = function() {
			...
			function o(t, e) {
				...
				return i(t, e, n), a(t, e, n), function(t, e, n) {
					var c = r(e),
						s = r(t);
					if ("object" === c) {
			...
			return r(e, [{
				...
				value: function(t, e) {
					var r = this.e || (this.e = {}),
						n = r[t],
						o = [];
					if (n && e) for (var i = 0, a = n.length; i < a; i += 1) n[i].fn !== e && n[i].fn._ !== e && o.push(n[i]);
	...
	var C = function(e) {
			...
			function e(r) {
				...
				return t.exports = e = function(t) {
					...
					function e() {
						return z(t, arguments, l(this).constructor)
					}
	...
	function W(t) {
		return t.includes("?") ? W(t.split("?")[0]) : t.includes("#") ? W(t.split("#")[0]) : t.trim().toLowerCase().split(".").pop()
	}
	function I(t, e) {
	...
	function dt(t, e, r) {
		return L(e === lt || t instanceof Element, "".concat(r.join("."), " require '").concat(lt, "' or 'Element' type"))
	}
	var ht = {
		html: dt,
		disable: "?".concat(st),
			...
			return r(e, [{
				...
				value: function() {
					var t = this.art.option,
						e = t.theme,
						r = t.backdrop;
					this.$container.innerHTML = '<div class="art-undercover"></div><div class="art-video-player art-subtitle-show art-layer-show" style="--theme: '.concat(e, '"><video class="art-video"></video><div class="art-poster"></div><div class="art-subtitle"></div><div class="art-danmuku"></div><div class="art-layers"></div><div class="art-mask"><div class="art-state"></div></div><div class="art-bottom"><div class="art-progress"></div><div class="art-controls"><div class="art-controls-left"></div><div class="art-controls-right"></div></div></div><div class="art-loading"></div><div class="art-notice"><div class="art-notice-inner"></div></div><div class="art-settings"><div class="art-setting-inner"><div class="art-setting-body"></div></div></div><div class="art-info"><div class="art-info-panel"><div class="art-info-item"><div class="art-info-title">Player version:</div><div class="art-info-content">3.5.30</div></div><div class="art-info-item"><div class="art-info-title">Video url:</div><div class="art-info-content" data-video="src"></div></div><div class="art-info-item"><div class="art-info-title">Video volume:</div><div class="art-info-content" data-video="volume"></div></div><div class="art-info-item"><div class="art-info-title">Video time:</div><div class="art-info-content" data-video="currentTime"></div></div><div class="art-info-item"><div class="art-info-title">Video duration:</div><div class="art-info-content" data-video="duration"></div></div><div class="art-info-item"><div class="art-info-title">Video resolution:</div><div class="art-info-content"><span data-video="videoWidth"></span> x <span data-video="videoHeight"></span></div></div></div><div class="art-info-close">[x]</div></div><div class="art-mini-header"><div class="art-mini-title"></div><div class="art-mini-close">xD7</div></div><div class="art-contextmenus"></div></div>'), this.$undercover = this.query(".art-undercover"), this.$player = this.query(".art-video-player"), this.$video = this.query(".art-video"), this.$poster = this.query(".art-poster"), this.$subtitle = this.query(".art-subtitle"), this.$danmuku = this.query(".art-danmuku"), this.$bottom = this.query(".art-bottom"), this.$progress = this.query(".art-progress"), this.$controls = this.query(".art-controls"), this.$controlsLeft = this.query(".art-controls-left"), this.$controlsRight = this.query(".art-controls-right"), this.$layer = this.query(".art-layers"), this.$loading = this.query(".art-loading"), this.$notice = this.query(".art-notice"), this.$noticeInner = this.query(".art-notice-inner"), this.$mask = this.query(".art-mask"), this.$state = this.query(".art-state"), this.$setting = this.query(".art-settings"), this.$settingInner = this.query(".art-setting-inner"), this.$settingBody = this.query(".art-setting-body"), this.$info = this.query(".art-info"), this.$infoPanel = this.query(".art-info-panel"), this.$infoClose = this.query(".art-info-close"), this.$miniHeader = this.query(".art-mini-header"), this.$miniTitle = this.query(".art-mini-title"), this.$miniClose = this.query(".art-mini-close"), this.$contextmenu = this.query(".art-contextmenus"), r && (g(this.$settingInner, "art-backdrop-filter"), g(this.$info, "art-backdrop-filter"), g(this.$contextmenu, "art-backdrop-filter")), this.art.isMobile && g(this.$container, "art-mobile")
				}
			}, {
				key: "mobile",
				value: function() {
		...
		function() {
			var e = "undefined" != typeof window && void 0 !== window.document ? window.document : {},
				...
				n = function() {
					...
					], n = 0, o = r.length, i = {}; n < o; n++) if ((t = r[n]) && t[1] in e) {
	...
	function kt(t, e) {
		...
		t.once("ready", (function() {
			...
			}(t, e) : document.fullscreenEnabled || o.webkitSupportsFullscreen ?
			function(t, e) {
	...
	function jt(t, e) {
		...
		}(t, e) : o.webkitSupportsPresentationMode ?
		function(t, e) {
			var r = t.template.$video;
	...
	var Pt = function e(r) {
			...
			t(this, e), function(t, e) {
				...
				n(a, "click", (function() {
					...
					u < 5 ? G(1e3).then((function() {
						u += 1, e.url = r.url, l.show = "".concat(s.get("Reconnect"), ": ").concat(u)
					})) : (t.loading.show = !1, t.controls.show = !1, g(i, "art-error"), G(1e3).then((function() {
						l.show = s.get("Video load failed"), t.destroy(!1)
					})))
					...
					t.mask.show = !1, O(c, "display", "none")
				...
				Object.keys(r.moreVideoAttr).forEach((function(t) {
					i[t] = r.moreVideoAttr[t]
				})), r.muted && (i.muted = r.muted), r.volume && (i.volume = et(r.volume, 0, 1));
				var c = n.get("volume");
				c && (i.volume = et(c, 0, 1)), r.poster && O(a, "backgroundImage", "url(".concat(r.poster, ")")), r.autoplay && (i.autoplay = r.autoplay), i.controls = !1, e.url = r.url
			}(r, this), function(t, e) {
				...
				X(e, "getDataURL", {
					...
					value: function() {
						e.getDataURL().then((function(e) {
							I(e, "".concat(r.title || "artplayer", "_").concat(rt(o.currentTime), ".png")), t.emit("screenshot", e)
						}))
					}
				})
			}(r, this), kt(r, this), function(t, e) {
				var r = t.template.$player;
				X(e, "fullscreenWeb", {
					get: function() {
					...
					set: function(r) {
						if (r) {
							var a = i.videoWidth,
								...
								p = a / c,
								f = l / u;
							if (g(n, "art-auto-size"), f > p) O(o, "width", "".concat(u * p / l * 100, "%")), O(o, "height", "100%");
							else {
								var d = l / p / u * 100;
				...
				})), x(l, n.title || r.get("Mini player")), X(e, "mini", {
					get: function() {
						return w(c, "art-mini")
					},
					set: function(r) {
						if (r) {
							...
							var i = o.get("top"),
								a = o.get("left");
							if (i && a) O(c, "top", "".concat(i, "px")), O(c, "left", "".concat(a, "px")), R(u) || (o.del("top"), o.del("left"), e.mini = !0);
							else {
								var s = document.body,
									l = s.clientHeight - e.height - 50,
									f = s.clientWidth - e.width - 50;
								o.set("top", l), o.set("left", f), O(c, "top", "".concat(l, "px")), O(c, "left", "".concat(f, "px"))
							}
				...
				X(e, "rotate", {
					...
					set: function(r) {
						...
						if (L(c.includes(r), "'rotate' only accept ".concat(c.toString(), " as parameters")), 0 === r) delete o.dataset.rotate, O(n, "transform", null);
							...
							O(n, "transform", "rotate(".concat(l, "deg) scale(").concat(u, ")"))
						}
			...
			return r(e, [{
				...
				value: function(t) {
					...
					if (this.$parent && this.name && !r.disable) {
						...
						a ? a.insertAdjacentElement("beforebegin", o) : x(this.$parent, o), r.html && x(o, r.html), r.style && k(o, r.style), r.tooltip && E(o, r.tooltip), r.click && this.art.events.proxy(o, "click", (function(t) {
				...
				value: function(t, e) {
					...
					g(s, "art-selector-list"), x(s, c), x(e, s);
					var l = function() {
							s.style.left = "-".concat(j(s, "width") / 2 - j(e, "width") / 2, "px")
						};
			...
			return Ft(Ft({}, t), {}, {
				...
				mounted: function(t) {
					var r = !1,
						...
						s = b(".art-progress-highlight", t),
						l = b(".art-progress-indicator", t),
						u = b(".art-progress-tip", t);

					function p(t, e) {
						"loaded" === t && O(o, "width", "".concat(100 * e, "%")), "played" === t && (O(c, "width", "".concat(100 * e, "%")), O(l, "left", "calc(".concat(100 * e, "% - ").concat(j(l, "width") / 2, "px)")))
					}
					n.forEach((function(t) {
						var e = et(t.time, 0, a.duration) / a.duration * 100;
						x(s, '<span data-text="'.concat(t.text, '" data-time="').concat(t.time, '" style="left: ').concat(e, '%"></span>'))
						...
						if (r) {
							var n = Wt(e, t),
								o = n.second,
								i = n.percentage;
							g(l, "art-show-indicator"), p("played", i), a.seek = o
						}
					})), i(document, "mouseup", (function() {
						r && (r = !1, m(l, "art-show-indicator"))
					}))
				}
			})
		}
				...
				mounted: function(t) {
					...
					i(n, "mousemove", (function(o) {
						c || (c = !0, a(r.url).then((function() {
							s = !0
						}))), s && (O(t, "display", "block"), function(o) {
							var i = Wt(e, o).width,
								a = r.url,
								c = r.height,
								s = r.width,
								...
								d = Math.ceil(f / u) - 1,
								h = f % u || u - 1;
							O(t, "backgroundImage", "url(".concat(a, ")")), O(t, "height", "".concat(c, "px")), O(t, "width", "".concat(s, "px")), O(t, "backgroundPosition", "-".concat(h * s, "px -").concat(d * c, "px")), i <= s / 2 ? O(t, "left", 0) : i > n.clientWidth - s / 2 ? O(t, "left", "".concat(n.clientWidth - s, "px")) : O(t, "left", "".concat(i - s / 2, "px"))
						}(o))
	...
	var ie = function(e) {
			...
			function o(e) {
				...
				return r.mouseMoveTime = Date.now(), e.on("mousemove", (function() {
					r.show = !0, m(c, "art-hide-cursor"), g(c, "art-hover"), r.mouseMoveTime = Date.now()
				})), e.on("video:timeupdate", (function() {
					a.playing && r.show && Date.now() - r.mouseMoveTime >= 3e3 && (r.show = !1, g(c, "art-hide-cursor"), m(c, "art-hover"))
							...
							return _t(_t({}, t), {}, {
								mounted: function(t) {
									var r = e.events.proxy,
										...
										c = x(t, n.volume),
										s = x(t, n.volumeClose),
										l = x(t, '<div class="art-volume-panel"></div>'),
										u = x(l, '<div class="art-volume-slider-handle"></div>');
									...
									function f() {
										...
										if (o.muted || 0 === t) O(c, "display", "none"), O(s, "display", "flex"), O(u, "left", "0");
										else {
											var e = 48 * t;
											O(c, "display", "flex"), O(s, "display", "none"), O(u, "left", "".concat(e, "px"))
										}
									}
									E(c, i.get("Mute")), O(s, "display", "none"), e.isMobile && O(l, "display", "none"), f(o.volume), e.on("video:volumechange", (function() {
										f(o.volume)
									})), r(c, "click", (function() {
										o.muted = !0
									})), r(s, "click", (function() {
			...
			return r(o, [{
				...
				value: function(t) {
					...
					Et(l(o.prototype), "add", this).call(this, e)
				}
			}]), o
		}(Rt);
	...
	var me = function(e) {
			...
			function n(e) {
				...
				var i = e.option,
					...
					s = a.$contextmenu,
					l = e.events.proxy;
				return o.$parent = s, e.once("ready", (function() {
					o.add(function(t) {
						return function(e) {
							var r = e.i18n,
								n = e.player;
						...
						return de(de({}, t), {}, {
							html: '<a href="https://yingkuya.com" target="_blank">影库鸭</a>'
						})
					}({
						disable: !1,
						name: "version",
						...
						var e = t.clientX,
							...
							h = e - l,
							y = r - u;
						e + d > l + a && (h = a - d), r + f > u + i && (y = i - f), k(s, {
							top: "".concat(y, "px"),
							left: "".concat(h, "px")
						})
			...
			return r(o, [{
				...
				value: function(t) {
					...
					if (!u) {
						...
						p.
					default = !0, p.kind = "metadata", l.appendChild(p), this.art.template.$track = p, i(this.textTrack, "cuechange", this.update.bind(this))
					}
					return fetch(t).then((function(t) {
						return t.arrayBuffer()
					})).then((function(n) {
						var o = new TextDecoder(r.encoding || a.encoding).decode(n);
						switch (e.art.emit("subtitleLoad", t), r.ext || W(t)) {
						case "srt":
							return q(M(o));
						case "ass":
							return q(F(o));
			...
			function e(r) {
				...
				t(this, e), this.destroyEvents = [], this.proxy = this.proxy.bind(this), this.hover = this.hover.bind(this), this.loadImg = this.loadImg.bind(this), r.whitelist.state && r.once("ready", (function() {
					...
					function(t, e) {
						...
						var r = t.template.$player;
						e.hover(r, (function() {
							g(r, "art-hover"), t.emit("hover", !0)
						}), (function() {
							m(r, "art-hover"), t.emit("hover")
						}))
					}(r, n), function(t, e) {
						var r = t.template.$player;
		...
		function i(n) {
			...
			O(n, "position", "relative"), k(o, {
				...
				function(e) {
					if (e) {
						var n = W(e.name);
						["ass", "vtt", "srt"].includes(n) ? (r.
						switch (URL.createObjectURL(e), {
							name: e.name,
							ext: n
	...
	return console.log("%c 影库鸭 %c 播放器 %c https://yingkuya.com", "color: #fff; background: #5f5f5f", "color: #fff; background: #4bc729", ""), nr
}));